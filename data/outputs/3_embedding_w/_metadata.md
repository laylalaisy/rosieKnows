...
--- Chunk 1 | score=0.6351 ---
source=data/sample.txt chunk_index=0
...
--- Chunk 2 | score=0.5672 ---
source=data/sample.txt chunk_index=5
...
--- Chunk 3 | score=0.2953 ---
source=data/sample.txt chunk_index=1
...
1. Ingestion Pipeline - loading, parsing, and chunking documents.
2. Embedding Layer - transforming chunks into vector representations.
3. Vector Storage - storing the embeddings for retrieval.
❯ git status
On branch main
